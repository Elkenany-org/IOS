...
//       (.init(title: "الكناني آضمن", description: "هتقدر توصل لمعلومات وشركات المجال البيطري والزراعي مع الكناني بشكل اسهل ", coverImage: #imageLiteral(resourceName: "Artboard 18"), buttonColor: #colorLiteral(red: 0, green: 0.2823529412, blue: 0.2, alpha: 1), buttontitle: "تسجيل الدخول"))]
    ...
    static var moredata:[MoreDataa] = [(.init(title: "البورصة اليومية", coverImage: #imageLiteral(resourceName: "stock-market"))),
                                       (.init(title: "دليل الشركات", coverImage: #imageLiteral(resourceName: "guide"))),
                                       (.init(title:  "سوق الكناني", coverImage: #imageLiteral(resourceName: "store"))),
                                       (.init(title: "الاخبار", coverImage: #imageLiteral(resourceName: "news"))),
                                       (.init(title: "المعارض", coverImage: #imageLiteral(resourceName: "news"))),
                                       (.init(title: "دلائل والمجلات", coverImage: #imageLiteral(resourceName: "news"))),
                                       (.init(title: "حركة السفن", coverImage: #imageLiteral(resourceName: "news"))),
                                       ...
                                       (.init(title: "قيم التطبيق", coverImage: #imageLiteral(resourceName: "star (1).png"))),
                                       (.init(title: "شارك التطبيق", coverImage: #imageLiteral(resourceName: "share.png"))),
