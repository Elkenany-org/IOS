...
//        GetComparing()
        ...
        comparingCV.delegate = self
            self.comparingCV.register(UINib(nibName: "comparCell", bundle: nil), forCellWithReuseIdentifier: "comparCell")
    }
...
//        return  DataaCompanyModell?.data?.companies?.count ?? 0
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cell1 = collectionView.dequeueReusableCell(withReuseIdentifier: "comparCell", for: indexPath) as? comparCell{
